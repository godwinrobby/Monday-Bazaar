  ...
  return (
    <div className="min-h-screen bg-slate-100 font-sans text-slate-900 selection:bg-orange-500 selection:text-white">
      <Routes>
        ...
        <Route path="categories" element={<AdminDashboard deals={deals} onAddDeal={onAddDeal} onUpdateDeal={onUpdateDeal} onDeleteDeal={onDeleteDeal} onCloseAdmin={() => navigate('/')} adminUser={adminUser} onLogout={handleLogout} />} />
